...
INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900169, 2, 1, 'https://brunch.co.kr/@iknowabby/24', '마케터의 출근길 메이트 : 12개 무료 뉴스레터 추천', 2, 6, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900169, 900169, '출근길에 가볍게 읽기 좋은 무료 뉴스레터 12개를 마케터 관점에서 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900169, 6, 17, true, false, true, 0, NULL, '마케터의 출근길 메이트 : 12개 무료 뉴스레터 추천', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900170, 14, 1, 'https://joomaltory.com/feed/cm2hy5sun00dkg36f65p49x5a', '심심할 때 들으면 빠져드는 팟캐스트 추천', 14, 1, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900170, 900170, '심심할 때 듣기 좋은 팟캐스트를 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900170, 1, 17, false, true, true, 3, now() - interval '4 days', '심심할 때 들으면 빠져드는 팟캐스트 추천', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900171, 12, 1, 'https://www.godo.co.kr/main/blog/25/%EC%87%BC%ED%95%91%EB%AA%B0-SEO%EB%B6%80%ED%84%B0-AI-%EA%B2%80%EC%83%89-%EC%B5%9C%EC%A0%81%ED%99%94%EA%B9%8C%EC%A7%80-%EB%85%B8%EC%B6%9C-%EC%98%AC%EB%A6%AC%EB%8A%94-%EC%8B%A4%EC%A0%84-%EB%B0%A9%EB%B2%95-4725', '2025년 AI 검색 최적화 실전 가이드｜쇼핑몰을 위한 SEO + AEO + GEO 전략', 26, 2, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900171, 900171, 'AI 검색·추천이 커지는 흐름 속에서 SEO/AEO/GEO 전략과 쇼핑몰 실무 적용법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900171, 2, 17, true, true, true, 6, now() - interval '6 days', '2025년 AI 검색 최적화 실전 가이드｜쇼핑몰을 위한 SEO + AEO + GEO 전략', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900172, 2, 1, 'https://www.godo.co.kr/main/blog/25/%EB%B9%84%EC%A6%88%EB%8B%88%EC%8A%A4-%EC%84%B1%EC%9E%A5%EC%9D%84-%EB%8F%95%EB%8A%94-%EB%89%B4%EC%8A%A4%EB%A0%88%ED%84%B0-%EC%B6%94%EC%B2%9C-15%EA%B0%80%EC%A7%80-%EB%A7%88%EC%BC%80%ED%8C%85%EC%B0%BD%EC%97%85%EC%9D%B4%EC%BB%A4%EB%A8%B8%EC%8A%A4-4615', '비즈니스 성장을 돕는 뉴스레터 추천 15가지 (마케팅·창업·이커머스) 2026', 38, 3, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900172, 900172, '마케팅·창업·이커머스 실무에 도움되는 비즈니스 뉴스레터 15가지를 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900172, 3, 17, false, false, true, 9, now() - interval '8 days', '비즈니스 성장을 돕는 뉴스레터 추천 15가지 (마케팅·창업·이커머스) 2026', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900173, 14, 1, 'https://m.cafe.daum.net/subdued20club/LxCT/254423', '출퇴근 길에, 잠자기 전에 듣기 좋은 팟캐스트 추천(feat. 교양이 쌓이는 소리)', 50, 4, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900173, 900173, '출퇴근길과 잠자리에서 듣기 좋은 팟캐스트를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900173, 4, 17, true, true, true, 12, now() - interval '10 days', '출퇴근 길에, 잠자기 전에 듣기 좋은 팟캐스트 추천(feat. 교양이 쌓이는 소리)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900174, 12, 1, 'https://hitchhickr.substack.com/p/2026', '''2026 여행 트렌드'' 책이 곧 나온다고?', 62, 5, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900174, 900174, '2026년 여행 트렌드를 다루는 신간 소식을 전한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900174, 5, 17, false, true, true, 15, now() - interval '12 days', '''2026 여행 트렌드'' 책이 곧 나온다고?', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900175, 2, 1, 'https://daouoffice.com/blog/newsletter-homepage-recommend', '실무자 뉴스레터 추천 5선 | 트렌드와 경제 인사이트를 업무 성과로 바꾸는 법', 74, 6, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900175, 900175, '트렌드·경제 인사이트를 업무 성과로 연결하는 실무자용 뉴스레터 5선을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900175, 6, 17, true, false, true, 18, now() - interval '14 days', '실무자 뉴스레터 추천 5선 | 트렌드와 경제 인사이트를 업무 성과로 바꾸는 법', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900176, 14, 1, 'https://www.milemoa.com/bbs/board/9859456', '2시간 통근길에 들을 팟캐스트 혹은 오디오북 추천 게시글', 86, 1, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900176, 900176, '긴 통근 시간에 들을 만한 팟캐스트·오디오북을 추천받은 커뮤니티 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900176, 1, 17, false, true, true, 21, now() - interval '16 days', '2시간 통근길에 들을 팟캐스트 혹은 오디오북 추천 게시글', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900177, 12, 1, 'https://www.godo.co.kr/main/blog/25/%ED%8A%B8%EB%A0%8C%EB%93%9C-%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%99%84%EC%A0%84-%EC%A0%95%EB%B3%B5-%EC%9D%B4%EC%BB%A4%EB%A8%B8%EC%8A%A4-%ED%95%B5%EC%8B%AC-%EC%82%B4%ED%8E%B4%EB%B3%B4%EA%B8%B0-1166', '2026년 트렌드 키워드 이커머스 적용 사례와 실무 팁 총정리', 10, 2, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900177, 900177, '2026년 트렌드 키워드를 이커머스에 적용한 사례와 실무 팁을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900177, 2, 17, true, true, true, 2, now() - interval '18 days', '2026년 트렌드 키워드 이커머스 적용 사례와 실무 팁 총정리', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900178, 2, 1, 'https://sanghadong.com/%EC%A7%81%EC%9E%A5%EC%9D%B8-%EB%89%B4%EC%8A%A4%EB%A0%88%ED%84%B0-%EC%B6%94%EC%B2%9C-best3/', '직장인 뉴스레터 추천 Best3', 22, 3, 17, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900178, 900178, '직장인이 구독하기 좋은 뉴스레터 3가지를 꼽아 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900178, 3, 17, false, false, true, 5, now() - interval '20 days', '직장인 뉴스레터 추천 Best3', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900179, 12, 1, 'https://blog.tason.com/wordpress/2026-trends/', '2026 소비 트렌드, 달라진 소비자의 3가지 욕망', 3, 1, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900179, 900179, '2026년 달라진 소비자 욕망 3가지를 짚은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900179, 1, 18, true, false, true, 0, NULL, '2026 소비 트렌드, 달라진 소비자의 3가지 욕망', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900180, 7, 1, 'https://brunch.co.kr/@alexkang/1406', '[스타트업 마케팅] 아드리엘, 창업가 인터뷰', 15, 2, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900180, 900180, '광고 플랫폼 아드리엘 창업가를 인터뷰한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900180, 2, 18, false, true, true, 3, now() - interval '4 days', '[스타트업 마케팅] 아드리엘, 창업가 인터뷰', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900181, 4, 1, 'https://news.hada.io/topic?id=7682', 'DevTools-X : 오프라인용 개발자 유틸리티 모음', 27, 3, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900181, 900181, '오프라인에서도 쓸 수 있는 개발자 유틸리티 모음 DevTools-X를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900181, 3, 18, true, true, true, 6, now() - interval '6 days', 'DevTools-X : 오프라인용 개발자 유틸리티 모음', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900182, 12, 1, 'https://www.godo.co.kr/main/blog/32/%EC%BB%A4%EB%A8%B8%EC%8A%A4-%EC%84%B1%EC%9E%A5%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%86%8C%EB%B9%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-3%EA%B0%80%EC%A7%80%EC%99%80-%EC%A0%81%EC%9A%A9-%EC%82%AC%EB%A1%80-5077', '커머스 성장을 위한 2026 소비 트렌드 3가지와 적용 사례', 39, 4, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900182, 900182, '커머스 성장을 위한 2026년 소비 트렌드 3가지와 적용 사례를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900182, 4, 18, false, false, true, 9, now() - interval '8 days', '커머스 성장을 위한 2026 소비 트렌드 3가지와 적용 사례', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900183, 7, 1, 'https://brunch.co.kr/@zwang/39', '잘 나가는 스타트업 대표 10인과 10가지 브랜딩 법칙', 51, 5, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900183, 900183, '스타트업 대표 10인의 브랜딩 법칙을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900183, 5, 18, true, true, true, 12, now() - interval '10 days', '잘 나가는 스타트업 대표 10인과 10가지 브랜딩 법칙', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900184, 4, 1, 'https://news.hada.io/topic?id=6378', 'DevStream - 오픈소스 DevOps 툴체인 매니저(DTM)', 63, 6, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900184, 900184, '오픈소스 DevOps 툴체인 매니저 DevStream을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900184, 6, 18, false, true, true, 15, now() - interval '12 days', 'DevStream - 오픈소스 DevOps 툴체인 매니저(DTM)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900185, 12, 1, 'https://www.syncly.kr/blog/2026-fashion-macro-trends-brand-marketers', '2026 패션 트렌드: B2C 브랜드가 선점해야 할 5가지 메가 트렌드', 75, 1, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900185, 900185, '2026년 패션 시장의 5가지 메가 트렌드를 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900185, 1, 18, true, false, true, 18, now() - interval '14 days', '2026 패션 트렌드: B2C 브랜드가 선점해야 할 5가지 메가 트렌드', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900186, 7, 1, 'https://brunch.co.kr/@amandaking/82', '밀레니얼 여성 스타트업 창업가 인터뷰 ''넉아웃'' 편', 87, 2, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900186, 900186, '여성 스타트업 창업가를 인터뷰한 시리즈 중 한 편.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900186, 2, 18, false, true, true, 21, now() - interval '16 days', '밀레니얼 여성 스타트업 창업가 인터뷰 ''넉아웃'' 편', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900187, 4, 1, 'https://news.hada.io/weekly/202405', '[GN#238] 개발자 생산성 측정하기: 구글, 노션 등의 실제 사례들', 11, 3, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900187, 900187, '구글·노션 등이 개발자 생산성을 측정하는 실제 사례를 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900187, 3, 18, true, true, true, 2, now() - interval '18 days', '[GN#238] 개발자 생산성 측정하기: 구글, 노션 등의 실제 사례들', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900188, 12, 1, 'https://www.ohprint.me/blog/2026-marketing-trend-goods', '트렌드 코리아 2026: 자영업자/사장님이 꼭 봐야 할 마케팅 키워드 3가지', 23, 4, 18, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900188, 900188, '트렌드 코리아 2026에서 소상공인이 참고할 마케팅 키워드 3가지를 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900188, 4, 18, false, false, true, 5, now() - interval '20 days', '트렌드 코리아 2026: 자영업자/사장님이 꼭 봐야 할 마케팅 키워드 3가지', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900189, 8, 1, 'https://www.elancer.co.kr/blog/detail/150', '노션 템플릿 사용법 TOP5, 일 잘러 프리랜서가 될 수 있는 지름길 대공개!', 4, 2, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900189, 900189, '프리랜서를 위한 노션 템플릿 활용법 TOP5를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900189, 2, 19, true, false, true, 0, NULL, '노션 템플릿 사용법 TOP5, 일 잘러 프리랜서가 될 수 있는 지름길 대공개!', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900190, 7, 1, 'https://community.rememberapp.co.kr/post/47898', '스타트업 현직자 인터뷰나 기업문화 소개 사이트 모아봤습니다', 16, 3, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900190, 900190, '스타트업 인터뷰·기업문화 소개 사이트를 모아 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900190, 3, 19, false, true, true, 3, now() - interval '4 days', '스타트업 현직자 인터뷰나 기업문화 소개 사이트 모아봤습니다', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900191, 8, 1, 'https://flexwork.co.kr/blog/notion-worklog-template-2405', '프로 일잘러가 노션 업무일지 쓰는 법 (노션 템플릿 공유)', 28, 4, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900191, 900191, '노션으로 업무일지를 쓰는 법과 템플릿을 공유한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900191, 4, 19, true, true, true, 6, now() - interval '6 days', '프로 일잘러가 노션 업무일지 쓰는 법 (노션 템플릿 공유)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900192, 7, 1, 'https://www.elancer.co.kr/blog/detail/184', '비즈니스 모델, 성공하는 비즈니스를 위한 핵심 전략 요소', 40, 5, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900192, 900192, '실제 사례로 비즈니스 모델의 핵심 전략 요소를 설명한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900192, 5, 19, false, false, true, 9, now() - interval '8 days', '비즈니스 모델, 성공하는 비즈니스를 위한 핵심 전략 요소', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900193, 8, 1, 'https://gongysd.com/notion-guide/?bmode=view&idx=168168412', '일잘러 노션 템플릿 10가지 추천 (업무 효율 200% 올리는 필수템)', 52, 6, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900193, 900193, '업무 효율을 높여주는 노션 템플릿 10가지를 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900193, 6, 19, true, true, true, 12, now() - interval '10 days', '일잘러 노션 템플릿 10가지 추천 (업무 효율 200% 올리는 필수템)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900194, 7, 1, 'https://www.shopify.com/kr/blog/business-model', '비즈니스 모델 유형과 예시(2026)', 64, 1, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900194, 900194, '대표 사례로 다양한 비즈니스 모델 유형을 설명한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900194, 1, 19, false, true, true, 15, now() - interval '12 days', '비즈니스 모델 유형과 예시(2026)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900195, 8, 1, 'https://gongysd.com/template/?idx=22', '노션 템플릿 30종 모음 (2026) 가계부·업무·일정·포트폴리오 관리까지', 76, 2, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900195, 900195, '가계부부터 포트폴리오까지 쓸 수 있는 노션 템플릿 30종을 모은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900195, 2, 19, true, false, true, 18, now() - interval '14 days', '노션 템플릿 30종 모음 (2026) 가계부·업무·일정·포트폴리오 관리까지', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900196, 7, 1, 'https://www.fanruan.com/ko-kr/blog/business-model-canvas', '비즈니스 모델 캔버스 예시로 보는 다양한 업계 사례', 88, 3, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900196, 900196, '업계별 비즈니스 모델 캔버스 사례를 비교한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900196, 3, 19, false, true, true, 21, now() - interval '16 days', '비즈니스 모델 캔버스 예시로 보는 다양한 업계 사례', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900197, 8, 1, 'https://cashverygood.com/entry/%EC%97%85%EB%AC%B4%EB%B3%84-%ED%85%9C%ED%94%8C%EB%A6%BF-%EC%B6%94%EC%B2%9C-%EB%B0%8F-%EC%A0%81%EC%9A%A9-%EB%B0%A9%EB%B2%95', '업무별 템플릿 추천 및 적용 방법', 12, 4, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900197, 900197, '업무 종류별로 어울리는 템플릿과 적용법을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900197, 4, 19, true, true, true, 2, now() - interval '18 days', '업무별 템플릿 추천 및 적용 방법', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900198, 7, 1, 'https://innomove.com/blog/business-model-framework/', '비즈니스 모델은 무엇인가? - 정의, 역사, 활용 방법', 24, 5, 19, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900198, 900198, '비즈니스 모델의 정의와 역사, 활용 방법을 설명한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900198, 5, 19, false, false, true, 5, now() - interval '20 days', '비즈니스 모델은 무엇인가? - 정의, 역사, 활용 방법', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900199, 6, 1, 'https://brunch.co.kr/@mobility/162', '이직 시 연봉 협상은 이렇게 하세요', 0, 3, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900199, 900199, '이직할 때 연봉 협상하는 방법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900199, 3, 20, true, false, true, 0, NULL, '이직 시 연봉 협상은 이렇게 하세요', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900200, 5, 1, 'https://brunch.co.kr/@adelahan/572', '미라클 모닝 루틴 (3)', 12, 4, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900200, 900200, '미라클모닝을 실천하며 독서 습관이 생긴 경험을 기록한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900200, 4, 20, false, true, true, 3, now() - interval '4 days', '미라클 모닝 루틴 (3)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900201, 10, 1, 'https://trost.co.kr/community/mentalhealth_column/114443922', '번아웃 극복 방법 정리│번아웃 회복 단계, 치료 방법 확인하기', 24, 5, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900201, 900201, '번아웃 회복 단계와 치료 방법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900201, 5, 20, true, true, true, 6, now() - interval '6 days', '번아웃 극복 방법 정리│번아웃 회복 단계, 치료 방법 확인하기', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900202, 6, 1, 'https://groupby.careers/%EC%9D%B4%EC%A7%81%EC%97%B0%EB%B4%89-%ED%98%91%EC%83%81-%EA%B3%BC%EC%A0%95-%ED%9B%84%EA%B8%B0-%EA%B2%BD%EB%A0%A5%EC%A7%81-%EC%97%B0%EB%B4%89%ED%98%91%EC%83%81-%EA%BF%80%ED%8C%81/', '이직연봉 협상 과정 후기 경력직 연봉협상 꿀팁', 36, 6, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900202, 900202, '경력직 이직 연봉 협상 과정과 꿀팁을 담은 후기.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900202, 6, 20, false, false, true, 9, now() - interval '8 days', '이직연봉 협상 과정 후기 경력직 연봉협상 꿀팁', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900203, 5, 1, 'https://brunch.co.kr/@jovia/3', '[책 리뷰] 미라클모닝', 48, 1, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900203, 900203, '자기계발서 ''미라클모닝''을 읽고 쓴 리뷰.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900203, 1, 20, true, true, true, 12, now() - interval '10 days', '[책 리뷰] 미라클모닝', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900204, 10, 1, 'https://trost.co.kr/community/mentalhealth_column/117678887', '번아웃 극복 방법 정리│감정 에너지 관리/지키는 법', 60, 2, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900204, 900204, '감정 에너지를 관리하고 지키는 법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900204, 2, 20, false, true, true, 15, now() - interval '12 days', '번아웃 극복 방법 정리│감정 에너지 관리/지키는 법', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900205, 6, 1, 'https://brunch.co.kr/@beautyinsight/35', '나만의 이력서로 이직 성공한 후기', 72, 3, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900205, 900205, '자신만의 이력서로 이직에 성공한 경험담.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900205, 3, 20, true, false, true, 18, now() - interval '14 days', '나만의 이력서로 이직 성공한 후기', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900206, 5, 1, 'https://bookpost.kr/entry/%EB%8F%85%EC%84%9C%ED%9B%84%EA%B8%B0-%EB%AF%B8%EB%9D%BC%ED%81%B4-%EB%AA%A8%EB%8B%9D', '독서후기 : 미라클 모닝', 84, 4, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900206, 900206, '''미라클모닝''을 읽고 쓴 독서 후기.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900206, 4, 20, false, true, true, 21, now() - interval '16 days', '독서후기 : 미라클 모닝', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900207, 10, 1, 'https://trost.co.kr/community/mentalhealth_column/121427312', '번아웃증후군 4단계ㅣ직장인 번아웃, 이렇게 시작되고 회복됩니다', 8, 5, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900207, 900207, '직장인 번아웃증후군 4단계와 회복 팁을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900207, 5, 20, true, true, true, 2, now() - interval '18 days', '번아웃증후군 4단계ㅣ직장인 번아웃, 이렇게 시작되고 회복됩니다', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900208, 6, 1, 'https://www.codestates.com/blog/content/%EB%A7%88%EC%BC%80%ED%84%B0-%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4-%EC%9E%91%EC%84%B1%EB%B2%95-%EC%98%88%EC%8B%9C', '마케터 포트폴리오 작성법 | 꿀팁 4가지, 예시·템플릿 추천', 20, 6, 20, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900208, 900208, '마케터 포트폴리오 작성 꿀팁과 예시를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900208, 6, 20, false, false, true, 5, now() - interval '20 days', '마케터 포트폴리오 작성법 | 꿀팁 4가지, 예시·템플릿 추천', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900209, 12, 1, 'https://filmora.wondershare.kr/useful-information/latest-meme-trends.html', '틱톡·인스타그램에서 인기 폭발! 요즘 유행하는 밈 베스트', 1, 4, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900209, 900209, '틱톡·인스타그램에서 유행하는 밈을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900209, 4, 21, true, false, true, 0, NULL, '틱톡·인스타그램에서 인기 폭발! 요즘 유행하는 밈 베스트', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900210, 9, 1, 'https://ohou.se/cards/feed?query=%EC%9E%90%EC%B7%A8%EA%BF%80%ED%85%9C', '자취꿀템 사진 검색결과', 13, 5, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900210, 900210, '자취 필수템을 모아볼 수 있는 오늘의집 피드.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900210, 5, 21, false, true, true, 3, now() - interval '4 days', '자취꿀템 사진 검색결과', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900211, 12, 1, 'https://v.daum.net/v/20251022193248299', 'SNS서 폭발적 반응…요즘 뜨는 ''MZ 밈'' 뭐길래', 25, 6, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900211, 900211, 'SNS에서 화제가 된 MZ세대 밈을 다룬 기사.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900211, 6, 21, true, true, true, 6, now() - interval '6 days', 'SNS서 폭발적 반응…요즘 뜨는 ''MZ 밈'' 뭐길래', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900212, 9, 1, 'https://www.womansense.co.kr/news/articleView.html?idxno=44453', '집 안에 카페를 들이자! 머물고 싶은 홈 카페 인테리어', 37, 1, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900212, 900212, '집에서 즐기는 홈카페 인테리어를 소개한 기사.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900212, 1, 21, false, false, true, 9, now() - interval '8 days', '집 안에 카페를 들이자! 머물고 싶은 홈 카페 인테리어', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900213, 12, 1, 'https://gogumafarm.kr/%EB%82%98-%EA%B3%A0%EA%B5%AC%EB%A7%88%ED%8C%9C%EC%9D%B8%EB%8D%B0-%EC%9A%94%EC%A6%98-%EB%9C%A8%EB%8A%94-%EB%B0%88-%EA%B0%80%EC%A0%B8%EC%99%94%EB%8B%A4-2026%EB%85%84-6%EC%9B%94-%EC%B5%9C%EC%8B%A0/', '나 고구마팜인데 요즘 뜨는 밈 가져왔다 (2026년 6월 최신 밈 모음)', 49, 2, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900213, 900213, '2026년 6월 기준 최신 밈을 모은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900213, 2, 21, true, true, true, 12, now() - interval '10 days', '나 고구마팜인데 요즘 뜨는 밈 가져왔다 (2026년 6월 최신 밈 모음)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900214, 9, 1, 'https://www.homify.co.kr/ideabooks/3878610/%EC%A7%91%EC%95%88%EC%97%90-%EB%82%98%EB%A7%8C%EC%9D%98-%EC%B9%B4%ED%8E%98%EB%A5%BC-%EB%A7%8C%EB%93%A4%EB%8B%A4,-%EC%97%AC%EC%9C%A0%EB%A5%BC-%EB%8B%B4%EC%95%84%EB%82%B4%EB%8A%94-%EA%B3%B5%EA%B0%84-%EC%9D%B8%ED%85%8C%EB%A6%AC%EC%96%B4-10', '집안에 나만의 카페를 만들다, 여유를 담아내는 공간 인테리어 10', 61, 3, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900214, 900214, '나만의 홈카페 공간 인테리어 아이디어 10가지를 모은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900214, 3, 21, false, true, true, 15, now() - interval '12 days', '집안에 나만의 카페를 만들다, 여유를 담아내는 공간 인테리어 10', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900215, 12, 1, 'https://blog.hsad.co.kr/category/%ED%8A%B8%EB%A0%8C%EB%93%9C/%EC%9D%B4%EB%8B%AC%EC%9D%98%20%ED%8A%B8%EB%A0%8C%EB%93%9C%20%EB%B0%88%EC%A7%91', '''트렌드/이달의 트렌드 밈집'' 카테고리 글 목록', 73, 4, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900215, 900215, '매달 화제가 된 밈을 정리하는 HSAD 공식 블로그 카테고리.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900215, 4, 21, true, false, true, 18, now() - interval '14 days', '''트렌드/이달의 트렌드 밈집'' 카테고리 글 목록', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900216, 9, 1, 'https://www.hyundailivart.co.kr/community/magazine/B000008200?sortBy=cncnCnt', '여유 공간을 활용해 만드는 나만의 홈카페', 85, 5, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900216, 900216, '자투리 공간을 활용한 홈카페 만들기를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900216, 5, 21, false, true, true, 21, now() - interval '16 days', '여유 공간을 활용해 만드는 나만의 홈카페', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900217, 12, 1, 'https://somako.co.kr/%EC%B0%B8-%EC%A2%8B%EB%8B%A4-%EB%A7%88%EC%BC%80%ED%84%B0-%ED%99%9C%EC%9A%A9-%EA%B0%80%EB%8A%A5%ED%95%9C-2026-12%EC%9B%94-%EC%B5%9C%EC%8B%A0-%EC%9C%A0%ED%96%89-%EB%B0%88/', '요즘 밈 트렌드 폼 좋다 (2026년 1~2월 최신 밈 모음.zip)', 9, 6, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900217, 900217, '2026년 1~2월 최신 밈을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900217, 6, 21, true, true, true, 2, now() - interval '18 days', '요즘 밈 트렌드 폼 좋다 (2026년 1~2월 최신 밈 모음.zip)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900218, 9, 1, 'https://www.homify.co.kr/ideabooks/2982726/%EB%82%A8%EB%85%80%EB%85%B8%EC%86%8C-%EB%88%84%EA%B5%AC%EB%82%98-%EC%82%AC%EB%9E%91%ED%95%A0,-%ED%99%88-%EC%B9%B4%ED%8E%98-%EC%9D%B8%ED%85%8C%EB%A6%AC%EC%96%B4-10', '남녀노소 누구나 사랑할, 홈 카페 인테리어 10', 21, 1, 21, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900218, 900218, '누구나 좋아할 홈카페 인테리어 아이디어 10가지를 모은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900218, 1, 21, false, false, true, 5, now() - interval '20 days', '남녀노소 누구나 사랑할, 홈 카페 인테리어 10', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900219, 15, 1, 'https://www.diningcode.com/list.dc?query=%EC%84%9C%EC%9A%B8%ED%98%BC%EB%B0%A5', '서울 혼밥 맛집 Top100', 2, 5, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900219, 900219, '서울에서 혼밥하기 좋은 맛집 100곳을 정리한 리스트.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900219, 5, 22, true, false, true, 0, NULL, '서울 혼밥 맛집 Top100', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900220, 14, 1, 'https://www.listennotes.com/best-podcasts/', '최고의 팟캐스트(2024) - 대한민국', 14, 6, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900220, 900220, '대한민국에서 인기 있는 팟캐스트 순위를 정리한 페이지.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900220, 6, 22, false, true, true, 3, now() - interval '4 days', '최고의 팟캐스트(2024) - 대한민국', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900221, 15, 1, 'https://www.esquirekorea.co.kr/article/1894456', '연말 혼밥은 ''이 식당''에서 하세요, 혼밥족을 위한 서울 맛집 추천 4', 26, 1, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900221, 900221, '혼밥족을 위한 서울 맛집 4곳을 추천한 기사.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900221, 1, 22, true, true, true, 6, now() - interval '6 days', '연말 혼밥은 ''이 식당''에서 하세요, 혼밥족을 위한 서울 맛집 추천 4', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900222, 14, 1, 'https://gogumafarm.kr/%EC%9A%94%EC%A6%98-%EC%97%AC%ED%96%89-%EC%9C%A0%ED%8A%9C%EB%B8%8C-%EB%AD%90-%EB%B4%84-z%EC%84%B8%EB%8C%80%EA%B0%80-%EC%B6%94%EC%B2%9C%ED%95%9C-%EC%9C%A0%ED%8A%9C%EB%B2%84-26%EC%9D%B8%EC%9D%84/', '요즘 여행 유튜버 뭐 봄? Z세대가 추천한 유튜버 26인', 38, 2, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900222, 900222, 'Z세대가 추천한 여행 유튜버 26인을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900222, 2, 22, false, false, true, 9, now() - interval '8 days', '요즘 여행 유튜버 뭐 봄? Z세대가 추천한 유튜버 26인', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900223, 15, 1, 'https://hotplacehunter.co.kr/sns/article/88620/', '''나만의 작은 아지트'' 혼밥족들이 사랑하는 서울 혼밥 맛집 5', 50, 3, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900223, 900223, '혼밥족들이 즐겨찾는 서울 맛집 5곳을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900223, 3, 22, true, true, true, 12, now() - interval '10 days', '''나만의 작은 아지트'' 혼밥족들이 사랑하는 서울 혼밥 맛집 5', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900224, 14, 1, 'https://www.cosmopolitan.co.kr/article/48880', '대리만족 갑, 시골살이 브이로그 추천 5', 62, 4, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900224, 900224, '시골살이 브이로그 채널 5개를 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900224, 4, 22, false, true, true, 15, now() - interval '12 days', '대리만족 갑, 시골살이 브이로그 추천 5', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900225, 15, 1, 'https://www.kkday.com/ko/blog/12233/asia-korea-seoul-suburbs', '서울 근교 여행 :: 서울 근교 갈 만한 곳 모음.zip', 74, 5, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900225, 900225, '서울 근교에서 가볼 만한 여행지를 모은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900225, 5, 22, true, false, true, 18, now() - interval '14 days', '서울 근교 여행 :: 서울 근교 갈 만한 곳 모음.zip', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900226, 14, 1, 'https://gogumafarm.kr/%EC%9A%94%EC%A6%98-20%EB%8C%80-%EC%97%AC%EC%9E%90%EB%93%A4%EC%9D%80-%EC%9C%A0%ED%8A%9C%EB%B8%8C-%EB%AD%90-%EB%B4%84-20%EB%8C%80-%EC%97%AC%EC%84%B1%EC%9D%B4-%EC%B6%94%EC%B2%9C%ED%95%9C-%EC%9C%A0/', '요즘 20대 여자들은 유튜브 뭐 봄? 20대 여성이 추천한 유튜버 30인', 86, 6, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900226, 900226, '20대 여성들이 추천한 유튜버 30인을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900226, 6, 22, false, true, true, 21, now() - interval '16 days', '요즘 20대 여자들은 유튜브 뭐 봄? 20대 여성이 추천한 유튜버 30인', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900227, 15, 1, 'https://www.kkday.com/ko/blog/13359/asia-korea-seoul-suburbs-drive-course', '서울 근교 드라이브 코스 BEST 7 :: 당일치기 여행 추천', 10, 1, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900227, 900227, '서울 근교 당일치기 드라이브 코스 7곳을 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900227, 1, 22, true, true, true, 2, now() - interval '18 days', '서울 근교 드라이브 코스 BEST 7 :: 당일치기 여행 추천', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900228, 14, 1, 'https://vling.net/en/post/222025665852', '감성 넘치는 브이로그/일상 유튜버 추천 Best 5', 22, 2, 22, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900228, 900228, '감성적인 브이로그·일상 유튜버 5명을 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900228, 2, 22, false, false, true, 5, now() - interval '20 days', '감성 넘치는 브이로그/일상 유튜버 추천 Best 5', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900229, 10, 1, 'https://www.hitnews.co.kr/news/articleView.html?idxno=65715', '[정신건강] 번아웃을 극복하는 ''느림''의 법칙', 3, 6, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900229, 900229, '번아웃 극복을 위한 ''느림''의 법칙을 다룬 기사.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900229, 6, 23, true, false, true, 0, NULL, '[정신건강] 번아웃을 극복하는 ''느림''의 법칙', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900230, 11, 1, 'https://brunch.co.kr/brunchbook/afterwork', '[브런치북] 퇴근 후 글 쓰러 갑니다', 15, 1, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900230, 900230, '퇴근 후 글쓰기를 사이드 프로젝트로 시작한 이야기를 담은 브런치북.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900230, 1, 23, false, true, true, 3, now() - interval '4 days', '[브런치북] 퇴근 후 글 쓰러 갑니다', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900231, 10, 1, 'https://www.youngju.dev/blog/mindset/burnout-permission-to-stop', '멈춘다고 뒤처지는 것이 아닙니다 — 번아웃에게 배운 것들', 27, 2, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900231, 900231, '번아웃을 겪으며 배운 것들을 기록한 개발자의 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900231, 2, 23, true, true, true, 6, now() - interval '6 days', '멈춘다고 뒤처지는 것이 아닙니다 — 번아웃에게 배운 것들', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900232, 11, 1, 'https://brunch.co.kr/brunchbook/worker-essay', '[브런치북] 직장인을 위한 에세이', 39, 3, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900232, 900232, '20년 직장 생활에서 쌓은 생각을 담은 에세이 브런치북.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900232, 3, 23, false, false, true, 9, now() - interval '8 days', '[브런치북] 직장인을 위한 에세이', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900233, 10, 1, 'https://brunch.co.kr/@morningwalk/887', '스트레스에 취약한 MBTI 유형: 유형별 스트레스 관리', 51, 4, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900233, 900233, 'MBTI 유형별로 스트레스에 취약한 정도와 관리법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900233, 4, 23, true, true, true, 12, now() - interval '10 days', '스트레스에 취약한 MBTI 유형: 유형별 스트레스 관리', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900234, 11, 1, 'https://brunch.co.kr/@patagwania/750', '브런치 볼만한 글 39가지 추천', 63, 5, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900234, 900234, '브런치에서 읽을 만한 글 39편을 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900234, 5, 23, false, true, true, 15, now() - interval '12 days', '브런치 볼만한 글 39가지 추천', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900235, 10, 1, 'https://rosieluri888.com/entry/MBTI-%EC%9C%A0%ED%98%95%EB%B3%84-%EC%8A%A4%ED%8A%B8%EB%A0%88%EC%8A%A4-%EB%B0%9B%EC%9D%84-%EB%95%8C-%EB%B0%98%EC%9D%91-%ED%95%B4%EC%86%8C%EB%B2%95', 'MBTI 유형별 스트레스 받을 때 반응 & 해소법', 75, 6, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900235, 900235, 'MBTI 유형별 스트레스 반응과 해소법을 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900235, 6, 23, true, false, true, 18, now() - interval '14 days', 'MBTI 유형별 스트레스 받을 때 반응 & 해소법', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900236, 11, 1, 'https://brunch.co.kr/@bonfire/104', '02화 퇴근 후 스타벅스로 출근하다', 87, 1, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900236, 900236, '퇴근 후 카페에서 개인 시간을 보내는 이야기를 담은 에세이.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900236, 1, 23, false, true, true, 21, now() - interval '16 days', '02화 퇴근 후 스타벅스로 출근하다', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900237, 10, 1, 'https://mindfulhealth.kr/%EC%A7%80%EC%B9%9C-%EC%A7%81%EC%9E%A5%EC%9D%B8%EC%9D%84-%EC%9C%84%ED%95%9C-%EB%B2%88%EC%95%84%EC%9B%83-%EA%B7%B9%EB%B3%B5-%EC%99%84%EC%A0%84%EC%A0%95%EB%B3%B5-%EC%97%90%EB%84%88%EC%A7%80-%ED%9A%8C/', '지친 직장인을 위한 번아웃 극복 완전정복: 에너지 회복 실전 전략 7가지', 11, 2, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900237, 900237, '직장인을 위한 번아웃 극복 실전 전략 7가지를 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900237, 2, 23, true, true, true, 2, now() - interval '18 days', '지친 직장인을 위한 번아웃 극복 완전정복: 에너지 회복 실전 전략 7가지', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900238, 11, 1, 'https://brunch.co.kr/@lyju7479/657', '직장인의 퇴근 후 루틴', 23, 3, 23, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900238, 900238, '퇴근 후 글쓰기와 소설 작업을 하는 직장인의 루틴을 담은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900238, 3, 23, false, false, true, 5, now() - interval '20 days', '직장인의 퇴근 후 루틴', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900239, 11, 1, 'https://brunch.co.kr/@brickmaker/279', '밤에 읽는 책, 낮에 읽는 책', 4, 1, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900239, 900239, '시간대에 따라 다르게 읽는 책에 대한 단상을 담은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900239, 1, 24, true, false, true, 0, NULL, '밤에 읽는 책, 낮에 읽는 책', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900240, 14, 1, 'https://youtube-rank.com/', '유튜브 랭킹', 16, 2, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900240, 900240, '국내 유튜브 채널 순위를 확인할 수 있는 사이트.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900240, 2, 24, false, true, true, 3, now() - interval '4 days', '유튜브 랭킹', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900241, 11, 1, 'https://brunch.co.kr/@dong02/2168', '내가 쓴 짧은 글(단상) 어록 명언 좋은글 모음', 28, 3, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900241, 900241, '짧은 글과 어록을 모아 정리한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900241, 3, 24, true, true, true, 6, now() - interval '6 days', '내가 쓴 짧은 글(단상) 어록 명언 좋은글 모음', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900242, 14, 1, 'https://music.apple.com/us/curator/apple-music-%EC%B6%9C%ED%87%B4%EA%B7%BC/1558257238?l=ko', 'Apple Music에서 만나는 출퇴근', 40, 4, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900242, 900242, '출퇴근길에 어울리는 곡들을 모은 Apple Music 큐레이션 플레이리스트.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900242, 4, 24, false, false, true, 9, now() - interval '8 days', 'Apple Music에서 만나는 출퇴근', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900243, 11, 1, 'https://www.allurekorea.com/2016/05/22/%EB%B0%A4%EC%97%90-%EC%9D%BD%EA%B8%B0-%EC%A2%8B%EC%9D%80-%EC%B1%85-%EC%97%AC%EC%84%AF-%EA%B6%8C/', '밤에 읽기 좋은 책 여섯 권', 52, 5, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900243, 900243, '밤에 읽기 좋은 책 6권을 소개한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900243, 5, 24, true, true, true, 12, now() - interval '10 days', '밤에 읽기 좋은 책 여섯 권', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900244, 14, 1, 'https://brunch.co.kr/@nitro2red/85', '넷플릭스 추천 다큐멘터리 10편', 64, 6, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900244, 900244, '넷플릭스에서 볼 만한 다큐멘터리 10편을 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900244, 6, 24, false, true, true, 15, now() - interval '12 days', '넷플릭스 추천 다큐멘터리 10편', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900245, 11, 1, 'https://brunch.co.kr/@2bfea4d6dfe2474/13', '30살이 되었고 나는 퇴사를 선택했다 (3)', 76, 1, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900245, 900245, '서른 살에 퇴사를 선택한 경험을 담은 에세이 3화.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900245, 1, 24, true, false, true, 18, now() - interval '14 days', '30살이 되었고 나는 퇴사를 선택했다 (3)', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900246, 14, 1, 'https://pickle.plus/blog/2024-%EB%84%B7%ED%94%8C%EB%A6%AD%EC%8A%A4-%EB%B2%94%EC%A3%84-%EB%8B%A4%ED%81%90-%EC%B6%94%EC%B2%9C%EC%9E%91', '안 보면 손해! 다큐 맛집 넷플릭스 범죄 다큐 추천 13', 88, 2, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900246, 900246, '넷플릭스에서 볼 만한 범죄 다큐멘터리 13편을 추천한 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900246, 2, 24, false, true, true, 21, now() - interval '16 days', '안 보면 손해! 다큐 맛집 넷플릭스 범죄 다큐 추천 13', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900247, 11, 1, 'https://r1.community.samsung.com/t5/%EA%B0%A4%EB%9F%AC%EB%A6%AC/%ED%87%B4%EA%B7%BC%EC%9D%84-%EA%B8%B0%EB%8B%A4%EB%A6%AC%EB%A9%B0/m-p/34669706/highlight/true', '퇴근을 기다리며', 12, 3, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900247, 900247, '퇴근을 기다리는 마음을 담은 커뮤니티 갤러리 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900247, 3, 24, true, true, true, 2, now() - interval '18 days', '퇴근을 기다리며', now(), now());

INSERT INTO linkus (linku_id, category_id, domain_id, linku_url, title, total_view_count, emotion_id, situation_id, created_at, updated_at) VALUES (900248, 14, 1, 'https://editk-story.com/entry/%EB%84%B7%ED%94%8C%EB%A6%AD%EC%8A%A4-%EC%B6%94%EC%B2%9C-%EB%B3%BC%EB%A7%8C%ED%95%9C-%EB%8B%A4%ED%81%90%EB%A9%98%ED%84%B0%EB%A6%AC-10%EC%84%A0', '넷플릭스 추천 볼만한 다큐멘터리 10선', 24, 4, 24, now(), now()) ON CONFLICT (linku_id) DO NOTHING;
INSERT INTO ai_articles (ai_article_id, linku_id, summary, created_at, updated_at) VALUES (900248, 900248, '넷플릭스에서 볼 만한 다큐멘터리 10편을 꼽은 글.', now(), now()) ON CONFLICT (ai_article_id) DO NOTHING;
INSERT INTO users_linkus (user_id, linku_id, emotion_id, situation_id, is_emotion_ai, is_situation_ai, is_ai_exist, view_count, last_viewed_at, title, created_at, updated_at) VALUES (103, 900248, 4, 24, false, false, true, 5, now() - interval '20 days', '넷플릭스 추천 볼만한 다큐멘터리 10선', now(), now());
