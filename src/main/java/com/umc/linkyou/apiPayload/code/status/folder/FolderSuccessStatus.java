...
public enum FolderSuccessStatus implements BaseSuccessCode {
    ...
    // 폴더 CRUD
    FOLDER_OK(HttpStatus.OK, "FOLDER2001", "내 폴더 트리 조회를 성공했습니다."),
    FOLDER_PARENT_OK(HttpStatus.OK, "FOLDER2002", "내 중분류 폴더 조회를 성공했습니다."),
    FOLDER_SUBFOLDER_OK(HttpStatus.OK, "FOLDER2003", "하위 폴더(소분류) 조회를 성공했습니다."),
    ...
    FOLDER_LINK_OK(HttpStatus.OK, "FOLDER2006", "폴더 내부 소분류 폴더+링크 목록 조회를 성공했습니다."),
    FOLDER_BOOKMARK_OK(HttpStatus.OK, "FOLDER2007", "폴더 북마크 상태 변경을 성공했습니다."),
    ...
    FOLDER_MEMBERS_OK(HttpStatus.OK, "FOLDER2010", "폴더 참여자 목록 조회를 성공했습니다."),
    FOLDER_PERMISSION_OK(HttpStatus.OK, "FOLDER2012", "폴더 권한 수정을 성공했습니다."),
    FOLDER_UNSHARE_OK(HttpStatus.OK, "FOLDER2013", "폴더를 비공개로 전환했습니다."),
    FOLDER_SHARED_OK(HttpStatus.OK, "FOLDER2014", "공유 받은 폴더 목록 조회를 성공했습니다."),
