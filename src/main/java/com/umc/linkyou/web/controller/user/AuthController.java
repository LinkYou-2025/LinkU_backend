...
public class AuthController implements AuthApi {
    ...
    public ApiResponse<UserResponseDTO.JoinResultDTO> join(@RequestBody @Valid UserRequestDTO.JoinDTO request) {
        ...
        return ApiResponse.of(AuthSuccessStatus.JOIN_SUCCESS, UserConverter.toJoinResultDTO(user));
    }

    @Override
    public ApiResponse<UserResponseDTO.LoginResultDTO> login(@RequestBody @Valid UserRequestDTO.LoginRequestDTO request) {
        return ApiResponse.of(AuthSuccessStatus.LOGIN_SUCCESS, userService.loginUser(request));
    }
    ...
    public ApiResponse<Void> sendPasswordResetLink(@RequestBody @Valid EmailRequestDTO.ResetLinkDTO request) {
        ...
        return ApiResponse.of(AuthSuccessStatus.PASSWORD_RESET_LINK_SENT, null);
    }
